...
$field_url = $_POST['url'];
// $field_url = "https://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
...
// if(mysqli_query($link, $sql)){
    ...
    try {
        ...
        $mail->Body    = ' <b>The Spark By ESNAAD - Enquiry </b> 
        ...
        header("Location: https://thespark.esnaad.com/thank-you.php");    
